...
const levelHypotheses: Record<Level, string> = {
  "입문자": "입문자 수준의 기본적인 포렌식 분석, 초급 학습자용 내용",
  "중급자": "중급자 수준의 심화 포렌식 분석, 실무자용 내용",
  "전문가": "전문가 수준의 고급 포렌식 분석, 숙련된 전문가용 내용",
};

const purposeHypotheses: Record<Purpose, string> = {
  "법정 증거 수집": "범죄 수사, 법정 증거 확보, 디지털 포렌식 조사",
  "침해사고 대응": "해킹, 악성코드, 침해사고 대응 및 분석",
  "일반 점검 및 교육": "일반 점검, 보안 입문 학습, 교육 목적",
};
